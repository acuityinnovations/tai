defmodule Tai.Commands.Helper do
  ...
  @spec enable_advisor_groups :: no_return
  defdelegate enable_advisor_groups, to: Tai.Commands.AdvisorGroups, as: :enable

  @spec enable_send_orders :: no_return
  defdelegate enable_send_orders, to: Tai.Commands.SendOrders, as: :enable

  @spec disable_advisor_groups :: no_return
  defdelegate disable_advisor_groups, to: Tai.Commands.AdvisorGroups, as: :disable
