defmodule Tai.ExchangeAdapters.New.Binance.OrderBookFeedTest do
  use ExUnit.Case
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney
  doctest Tai.ExchangeAdapters.New.Binance.OrderBookFeed
  ...
  setup do
    ...
    {:ok, my_binance_feed_pid} =
      use_cassette "exchange_adapters/binance/order_book_feed" do
        Tai.ExchangeAdapters.New.Binance.OrderBookFeed.start_link(
