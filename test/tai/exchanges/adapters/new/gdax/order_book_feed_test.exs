defmodule Tai.ExchangeAdapters.New.Gdax.OrderBookFeedTest do
  use ExUnit.Case
  use ExVCR.Mock, adapter: ExVCR.Adapter.Hackney
  doctest Tai.ExchangeAdapters.New.Gdax.OrderBookFeed
  ...
  setup do
    ...
    {:ok, my_gdax_feed_pid} =
      use_cassette "exchange_adapters/gdax/order_book_feed" do
        Tai.ExchangeAdapters.New.Gdax.OrderBookFeed.start_link(
