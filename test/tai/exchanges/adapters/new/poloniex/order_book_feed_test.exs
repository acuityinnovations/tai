defmodule Tai.ExchangeAdapters.New.Poloniex.OrderBookFeedTest do
  use ExUnit.Case
  doctest Tai.ExchangeAdapters.New.Poloniex.OrderBookFeed
  ...
  setup do
    ...
    {:ok, my_poloniex_feed_pid} =
      Tai.ExchangeAdapters.New.Poloniex.OrderBookFeed.start_link(
